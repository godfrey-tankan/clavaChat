...
tenant_response = "*What apartment/house are you looking for and your budget?* - (`budget is optional`).\n- consider example: _2 bedroom apartment with tiles and ceiling in Sunningdale $300_ \n\ntype `exit` to exit "
