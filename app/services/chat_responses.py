...
invalid_sale_response =  "⚠️Your product details are invalid.\n\n- Please provide the *product name* *condition* - (boxed,new,pre-owned or used) \n\n- 💡 Consider this example: \n- *iphone 11 pro 256GB Boxed*\n\n `reply with exit to exit.` "
invalid_house_information ="⚠️Invalid house information. \n\n- Please provide: *house description* in *location*\n\n- 💡 Consider this example: \n- *full house with en-suite* in *Gunhill* \n\n `reply with exit to exit.`"
